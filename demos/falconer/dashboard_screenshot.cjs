...
(async () => {
  ...
  await page.screenshot({ path: 'demos/falconer/demo-output/dashboard-flock.png', fullPage: true });
  console.log('Screenshot 1: Flock Status saved');

  // Screenshot: Tasks tab
  await page.click('.tab:has-text("Tasks")');
  await page.waitForTimeout(1500);
  await page.screenshot({ path: 'demos/falconer/demo-output/dashboard-tasks.png', fullPage: true });
  console.log('Screenshot 2: Tasks saved');

  // Screenshot: Mesh tab
  await page.click('.tab:has-text("Mesh")');
  await page.waitForTimeout(1000);
  await page.screenshot({ path: 'demos/falconer/demo-output/dashboard-mesh.png', fullPage: true });
  console.log('Screenshot 3: Mesh saved');

  // Screenshot: Governance tab
  await page.click('.tab:has-text("Governance")');
  await page.waitForTimeout(2000);
  await page.screenshot({ path: 'demos/falconer/demo-output/dashboard-governance.png', fullPage: true });
