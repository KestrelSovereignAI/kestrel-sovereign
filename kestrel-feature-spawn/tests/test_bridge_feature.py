...
from kestrel_feature_spawn.bridge.router import _build_context_note
...
class TestRouterHelpers:
    ...
    async def test_get_bridge_feature_missing_agent(self):
        from kestrel_feature_spawn.bridge.router import _get_bridge_feature
...
class TestGetRouter:
    def test_returns_api_router(self):
        from kestrel_feature_spawn.bridge.router import get_router
