...
def test_no_orphan_label_keys_in_legacy_theme(html_text, legacy_labels):
    ...
    surface_anchored_keys = {
        ...
        "sidebar_agents",
        # chat_history_title removed: the standalone console's #history-sidebar
        # was deleted when the console collapsed to a single conversation surface
        # (#2171/#2173), so the label is no longer surface-anchored.
        "chat_welcome_message", "chat_thinking",
