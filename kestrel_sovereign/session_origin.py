...
Deliberately a leaf module rather than a member of ``kestrel_sovereign.agent``:
its callers (the wait reconciler, the Talon coordinator, the restart
coordinator) do not otherwise import that package, and reaching into it for a
ten-line helper would drag the whole mixin stack — context builder, streaming,
orchestrator engine — into their import graph.
"""
