...
class StreamingMixin:
    ...
    async def _process_input_streaming_traced_locked(
        ...
        # Resolve the model THIS turn will use (override else FRESH solvency
        # check) before the compaction gate so both agree on the route — a
        # stale cached preference could mis-gate (codex review r5/r6). Reused at
        # the generate call below.
