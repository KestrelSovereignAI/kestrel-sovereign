...
const SOVEREIGNTY_BODY = `
    ...
    <div class="mt-5 section-divider">
        <div class="row-between mb-3">
            ...
            <button class="btn btn-secondary" id="toggle-db-explorer" type="button" aria-controls="db-explorer-section" aria-expanded="false"><span class="ki ki-cabinet" aria-hidden="true"></span> <span data-label-key="btn_browse_database">Browse Database</span></button>
        </div>
        ...
        <div id="db-explorer-section" style="display: none;" hidden>
