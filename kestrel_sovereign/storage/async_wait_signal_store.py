...
class WaitSignalStore:
    ...
    async def record_pending(
        ...
        *,
        ...
        (#2877) so the next tick's harvest can tell a *bound* delivery from one
        that went out with no destination of its own. Sticky: an empty value
        leaves any recorded session alone rather than orphaning a handle that
        already had one.
        """
