...
--                            NULL means no session was recorded, so the wake
--                            goes out unbound and its delivery status carries
--                            an ``_unbound`` suffix
--
...
class AsyncDatabase:
    ...
    async def _init_schema(self) -> None:
        ...
        # (no session recorded), which the reconciler reports as unbound.
        await self._migrate_add_column(
