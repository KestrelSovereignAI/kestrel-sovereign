...
from storage import AsyncStorage, PrivacyEnforcingStorage
from storage.encryption import DecryptionError
from llm.service import LLMService
from llm.adapter import LLMResponse
from config import TRUSTED_AGENTS_DIR
from typing import Optional, Dict, List, Any, Union
import re
from pathlib import Path
from privacy import PrivacyMode
from decimal import Decimal, getcontext
from extensions.app_extension import AppExtension
from features.wallet import WalletAgent
from features.privacy import PrivacyAgent
from features import discover_features, get_feature_by_name
from features.base import Feature
from command_handler import CommandHandler
from a2a.task_manager import TaskManager
from a2a.stores import (
...
from agent import ContextBuilder, ContextManager
from agent.constitution import ConstitutionMixin
from agent.streaming import StreamingMixin
from agent.backup import BackupMixin
from agent.sleep import SleepMixin
from storage.memory_consolidator import MemoryConsolidator
from hooks import HooksManager, HookEvent, HookInput, HookOutput
...
class KestrelAgent(ConstitutionMixin, StreamingMixin, BackupMixin, SleepMixin):
    ...
    async def initialize(self) -> None:
        ...
        if self._raw_storage is None:
            ...
            # All stores use the abstract data layer (SQLite for sovereign, PostgreSQL for Frinz)
            if self._db_backend.lower() == "postgres" and self.pg_pool:
                # PostgreSQL mode: use PostgreSQL stores with existing pool
                from frinz.a2a.postgres_stores import (
    ...
    # Solvency State
        ...
        self.app_context: Optional[str] = None # For app-specific logic (e.g., 'frinz', 'elderly')
...
"""
    ...
    async def _handle_orchestrator_response_streaming(
        ...
        for iteration in range(max_iterations):
            # Execute tool calls (this part cannot be streamed)
            for tool_call in response.tool_calls:
                tool_name = tool_call.name
                args = tool_call.arguments if isinstance(tool_call.arguments, dict) else {}
    ...
    def create_trusted_agent(self, agent_name: str) -> str:
        ...
        """
        from inception_service import generate_kestrel_identity, save_kestrel_identity
