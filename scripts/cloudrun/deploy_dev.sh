...
gcloud run deploy "$SERVICE_NAME" \
    ...
    --set-env-vars="KESTREL_ENV=development,KESTREL_DB_BACKEND=sqlite,KESTREL_DB_PATH=/app/agent_data,KESTREL_MULTI_AGENT=true,KESTREL_REQUIRE_OAUTH=true,KESTREL_ALLOWED_EMAILS=jaslogic@gmail.com\,noelschulz1981@gmail.com\,gabriela.aquino@gmail.com" \
    --project="$PROJECT_ID" \
    --quiet
