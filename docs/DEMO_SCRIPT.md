...
![Identity panel showing DID](demo-screenshots/01-did-identity.png)
...
![Agent response referencing constitutional principles](demo-screenshots/02-chat-response.png)
...
![Constitution panel with hash](demo-screenshots/03-constitution-panel.png)
...
![Agent confirms recall from memory records](demo-screenshots/05-memory-recalled.png)
...
![Knowledge Graph showing typed nodes](demo-screenshots/06-memories-panel.png)
...
![NORMAL privacy mode active](demo-screenshots/07-privacy-normal.png)
...
![All 5 privacy modes visible](demo-screenshots/08-privacy-dropdown.png)
...
![EPHEMERAL mode with red indicator](demo-screenshots/09-privacy-ephemeral.png)
...
![Ephemeral mode enforces local-only LLM](demo-screenshots/10-ephemeral-chat.png)
...
![Data Sovereignty panel](demo-screenshots/12-sovereignty-panel.png)
...
![Export modal with 3 storage tiers](demo-screenshots/13-export-modal.png)
