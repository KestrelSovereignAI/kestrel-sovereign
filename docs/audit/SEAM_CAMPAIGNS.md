...
1. Permission bypass through MCP, A2A, tools, and commands is proven for the in-core shared approval/audit boundary, including stale approval, replayed approval, forged/blank scope, A2A, command, and core-only MCP extraction paths.
