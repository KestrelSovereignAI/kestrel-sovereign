...
**Narrator:** "Kestrel isn't just chat - it's a platform for specialized AI companions. Let's load the Kestrel extension for relationship companionship."

**Demo Steps:**
1. Load extension: `!set-app-context kestrel`
...
- ✅ **Kestrel** - Romantic/friendship relationships
