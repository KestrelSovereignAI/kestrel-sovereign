...
| `kestrel_sovereign/endpoints/models.py::GET /api/ipfs/status` | D-3226 — shared IPFS daemon health and recursive pins lack agent ownership filtering or sovereign host-only enforcement. |
